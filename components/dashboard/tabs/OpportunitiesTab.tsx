      ...
      <div className="space-y-4">
        {matchingOpportunities.map((op) => {
          ...
          return (
            <div
              key={op.id}
              className={`bg-white border transition-all duration-300 rounded-3xl overflow-hidden shadow-sm hover:shadow-md ${
                isExpanded ? "border-green-600/60 ring-1 ring-green-600/10" : "border-stone-200/80"
              }`}
            >
              {/* Summary Row */}
              <div
              ...
              >
                <div className="space-y-1.5 flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <span
                      className={`px-2 py-0.5 text-[9px] font-bold rounded-full uppercase tracking-wide flex items-center gap-1 ${
                        isApplied
                    ...
                    <div className="p-5 md:p-6 space-y-5 text-xs md:text-sm">
                      ...
                      <div className="flex justify-end pt-2">
                        <button
                          ...
                          className={`px-6 py-3 rounded-2xl font-bold text-xs shadow-md transition-all flex items-center gap-2 cursor-pointer ${
                            isApplied
