...
const TESTIMONIAL = {
  quote:
    "I was part of the pilot in Enugu. My CitiEye officer helped me apply for the N-Power scheme — I wouldn't have known where to start on my own.",
  author: "Ngozi A.",
...
export default function AuthPage() {
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-white">
      ...
      <Suspense fallback={<div className="flex-1 flex items-center justify-center"><div className="w-8 h-8 border-2 border-green-700 border-t-transparent rounded-full animate-spin" /></div>}>
        <AuthContent />
      </Suspense>
    </div>
  );
